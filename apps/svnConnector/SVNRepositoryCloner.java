...
public class SVNRepositoryCloner {
    ...
    public static void clone(String URL, String repoPath) {
        /*
         * Default values:
        ...
        setupLibrary();
             ...
             */
            srcUrl = (URL != null) ? URL : srcUrl;
            /*
             * a target repository path
             */
            tgtPath = (repoPath != null) ? repoPath : tgtPath;
    ...
    private static void copyRevisionProperties(SVNRepository fromRepository, SVNRepository toRepository, long revision) throws SVNException {
        Map revProps = fromRepository.getRevisionProperties(revision, null).asMap();
        for (Iterator propNames = revProps.keySet().iterator(); propNames.hasNext();) {
            String propName = (String) propNames.next();
            SVNPropertyValue propValue =  (SVNPropertyValue) revProps.get(propName);
