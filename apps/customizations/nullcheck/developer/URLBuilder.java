...
public final class URLBuilder {
	...
	/**
	 * Choose what will be your base API. Currently available: USERS,
	 * REPOSITORES, and LEGACY see {@link GithubAPI}
	 * 
	 * @param api
	...
	/**
	 * Add a parameter and value to the URL. Differently of { withparam}, this
	 * method will not use ? or & to concatenate the url.
	 *
	 * @param key
	 * @param value
	 * @return current url representation
