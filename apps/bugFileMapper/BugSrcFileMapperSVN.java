...
public class BugSrcFileMapperSVN {
     ...
     */
    public BugSrcFileMapperSVN(String url, String path) {
...
*/
    public static void main(String[] args) {
        ...
        int index = 0;
        BugSrcFileMapperSVN bugsrcMapper = null;
        // path of the repository
        if (args.length < 1) {
            bugsrcMapper = new BugSrcFileMapperSVN("/Users/nmtiwari/Desktop/test/pagal/__clonedByBoa/projects/paninij");
        } else if (args.length == 2) {
            bugsrcMapper = new BugSrcFileMapperSVN(args[1], args[0]);
        } else {
            bugsrcMapper = new BugSrcFileMapperSVN(args[0]);
        }
