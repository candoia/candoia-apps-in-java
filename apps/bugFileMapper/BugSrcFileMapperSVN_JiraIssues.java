 ...
 */
public class BugSrcFileMapperSVN_JiraIssues {
	 ...
	 */
	public BugSrcFileMapperSVN_JiraIssues(String url, String path, String bug_url) {
...
//		}
	...
	public static void main(String[] args) {
		...
		int index = 0;
		BugSrcFileMapperSVN_JiraIssues bugsrcMapper = null;
		// path of the repository
		if (args.length == 3) {
			bugsrcMapper = new BugSrcFileMapperSVN_JiraIssues(args[0], args[1], args[2]);
		} else {
			bugsrcMapper = new BugSrcFileMapperSVN_JiraIssues("nmtiwari@/Users/nmtiwari/Desktop/test/pagal/panini/",
